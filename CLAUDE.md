...
- Todo entity with constructor-based initialization
...
### Frontend
- `src/frontend/App.tsx` - Main app layout component
...
- **Entity Creation**: Use constructor with object params: `new Todo({ title, description })`
...
- **Component Structure**: Separate concerns (App.tsx for layout, TodoApp.tsx for functionality)
...
- **Route Organization**: Separate route files in `src/server/routes/` with imports in main router